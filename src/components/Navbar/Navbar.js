...
class Navbar extends React.Component {
    ...
    render() {
        const { categoryName, setCategoryName, cartIsOpen, setCartIsOpen, currency, setCurrency, totalItems } = this.context

        return <div className="header">
            <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg" className="logo">
            ...
            <div className="actions">
                <div className="currency" onClick={() => this.setState({ currencyIsOpen: !(this.state.currencyIsOpen) })}>
                    ...
                    <div>
                        {this.state.currencyIsOpen ? <svg width="8" height="4" viewBox="0 0 8 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div onClick={() => setCartIsOpen(!cartIsOpen)} className="cart-icon">
