            ...
            >
                ...
                <div>
                    {this.state.isHovered && this.props.product.inStock ?
                        <svg width="74" height="74" viewBox="0 0 74 74" fill="none" xmlns="http://www.w3.org/2000/svg" className="cart-icon-small" onClick={() => addToCart({...this.props.product, quantity:1,  addedAttributes: attributesArray })}>
